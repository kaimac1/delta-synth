...
#define DISPLAY_I2C_SPEED 800000
...
void display_init(void) {
    ...
    LL_I2C_ConfigSpeed(I2C1, rcc_clocks.PCLK1_Frequency, DISPLAY_I2C_SPEED, LL_I2C_DUTYCYCLE_2);    
...
void display_reset(void) {
    ...
    ssd1306_command(0x00);                          // Vertical offset
